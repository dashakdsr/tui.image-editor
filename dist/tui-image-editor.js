...
})(this, function(__WEBPACK_EXTERNAL_MODULE_3__, __WEBPACK_EXTERNAL_MODULE_104__) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _graphics = __webpack_require__(103);
	...
	var ImageEditor = function () {
	    ...
	    _createClass(ImageEditor, [{
	        ...
	        key: 'addImageObject',
	        value: function addImageObject(imgUrl, obj) {
	            if (!imgUrl) {
	                return _promise2.default.reject(rejectMessages.invalidParameters);
	            }
	    ...
	    _mainAction: function _mainAction() {
	        ...
	        return (0, _tuiCodeSnippet.extend)({
	            ...
	            base64ToBlob: function base64ToBlob() {
	                ...
	                var blob = _util2.default.base64ToBlob(dataURL);
	    ...
	    _textAction: function _textAction() {
	        ...
	        return (0, _tuiCodeSnippet.extend)({
	            changeTextStyle: function changeTextStyle(styleObj) {
	                if (_this5._graphics._canvas._activeGroup) {
	                    var activeGroup = _this5._graphics._canvas._activeGroup._objects.map(function (item) {
	                        return item.__fe_id;
	                    });
	                    _this5.changeTextStyle(activeGroup, styleObj);
	                } else if (_this5.activeObjectId) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _fabric = __webpack_require__(104);

	var _fabric2 = _interopRequireDefault(_fabric);

	var _imageLoader = __webpack_require__(105);

	var _imageLoader2 = _interopRequireDefault(_imageLoader);

	var _cropper = __webpack_require__(107);

	var _cropper2 = _interopRequireDefault(_cropper);

	var _flip = __webpack_require__(109);

	var _flip2 = _interopRequireDefault(_flip);

	var _rotation = __webpack_require__(110);

	var _rotation2 = _interopRequireDefault(_rotation);

	var _freeDrawing = __webpack_require__(111);

	var _freeDrawing2 = _interopRequireDefault(_freeDrawing);

	var _line = __webpack_require__(112);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _cropzone = __webpack_require__(108);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _mask = __webpack_require__(116);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _drawingMode = __webpack_require__(124);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var command = {
	     ...
	     * @returns {Promise}
	     */
	    execute: function execute(graphics, imgUrl, obj) {
	        var _this = this;

	        return graphics.addImageObject(imgUrl, obj).then(function (objectProps) {
	            _this.undoData.object = graphics.getObject(objectProps.id);
